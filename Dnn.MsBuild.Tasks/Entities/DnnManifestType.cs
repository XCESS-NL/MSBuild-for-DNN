// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DnnManifestType.cs" company="XCESS expertise center b.v.">
...
// </copyright>
// <summary>
//   Defines the DnnManifestType type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Dnn.MsBuild.Tasks.Entities
{
    /// <summary>
    /// </summary>
    public enum DnnManifestType
    {
        /// <summary>
        /// The manifest is a package.
        /// </summary>
        Package
    }
}
