// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DnnGlobals.cs" company="XCESS expertise center b.v.">
...
namespace XCESS.MsBuild.Tasks
{
    /// <summary>
    /// </summary>
    internal class DnnGlobals
    {
        /// <summary>
        /// The DNN desktop module folder.
        /// </summary>
        public const string DnnDesktopModuleFolder = "DesktopModules";
