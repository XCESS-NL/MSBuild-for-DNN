// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Edit.cs" company="XCESS expertise center bv">
...
{
    [DnnModulePermission("myCODE", "myKEY", "myNAME")]
    [DnnModuleControl(DnnModuleControlKeys.Edit, "Edit Test", DnnControlType.Edit)]
