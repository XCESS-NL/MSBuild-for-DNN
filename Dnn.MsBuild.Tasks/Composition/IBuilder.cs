// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IBuilder.cs" company="XCESS expertise center bv">
...
namespace Dnn.MsBuild.Tasks.Composition
{
    ...
    {
        IManifestElement Build(IManifestData data);
    }

    internal interface IBuilder<out TElement>
        where TElement : IManifestElement
    {
        TElement Build(IManifestData data);
    }
}