// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DnnComponents.cs" company="XCESS expertise center b.v.">
...
// </copyright>
// <summary>
//   Defines the DnnComponents type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Dnn.MsBuild.Tasks.Entities
{
    ...
    public class DnnComponents
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DnnComponents"/> class.
        /// </summary>
        public DnnComponents()
        {
            this.Components = new List<DnnComponent>();
        }

        [XmlElement("component")]
        public List<DnnComponent> Components { get; private set; }
    }
}
